...
//         </div>
//       </div>
//       <div className="flex justify-center bg-[url('/assests/images/about-bg.png')]  bg-no-repeat bg-contain mb-20 ">
//         <div className="flex flex-col lg:flex-row ">
//           <div className="flex flex-col  mt-20 px-[120px]  ">
//             <h1
      ...
      <div className="flex justify-center  bg-[url('/assests/images/about-bg.png')]  bg-no-repeat bg-cover p-5">
        <div className="flex flex-col xl:flex-row sm:items-center  lg:px-[105px] ">
          <div className="flex flex-col mt-5 lg:mt-20 ">
            <h1
              className={`${fjalla.className} text-center sm:text-start font-bold not-italic text-[#3f7884] leading-[40px] sm:text-2xl lg:text-[33px] lg:mt-6 `}
            >
              We are founded and based in US
            </h1>
            <p className="not-italic text-[13px] lg:text-[17px] text-[#6eadb9] text-justify  leading-[28px] font-normal sm:pr-14 sm:mt-6">
              Our company brings over 20 years of extensive experience
              <br /> in the healthcare industry, specializing in areas such as
              billing and coding, insurance, provider services, revenue
              management cycles, and patient relationships.
