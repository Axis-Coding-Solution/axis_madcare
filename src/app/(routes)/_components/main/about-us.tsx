...
const AboutUs = () => {
  return (
    <div>
      ...
      <div className="bg-[url('/assests/images/about-us.png')] mt-10 bg-no-repeat h-[20vh] bg-top px-40">
        <div className="pl-[38%]  pt-3 text-primary text-4xl font-bold">
          <h1>ABOUT US</h1>
        </div>
      </div>
      <div className="flex justify-center bg-[url('/assests/images/about-bg.png')]  bg-no-repeat bg-contain">
        <div className="flex justify-between w-[70%]  ">
          ...
          <div className="flex w-full">
            <img src="/assests/images/health-care.png" />
          </div>
        </div>
      </div>
    </div>
