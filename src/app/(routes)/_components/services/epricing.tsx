...
function Epricing() {
  ...
  return (
    <>
     <div className="bg-[#3791A4] pt-10 mt-5 lg:pt-28 sm:mt-20 lg:pb-10 px-4  lg:px-5">
        <div className="bg-[url('/assests/images/bg-eye-care.png')] bg-no-repeat bg-contain   bg-[#3791A4] pb-10   sm:pb-20 ">
          <div className="flex flex-col lg:flex-row  gap-5 md:gap-10 ">
            <div className="xl:pl-[110px]  ">
              <Image
                className=" md:h-[500px] lg:h-[329px] sm:object-contain"
            ...
            <div className="">
              <h1
                className={`${fjalla.className} text-[#f0f4f9] md:px-8 lg:px-0 text-sm md:text-[33px] lg:text-[20px] xl:text-[33px] leading-[40px] text-center sm:text-start  font-bold not-italic`}
              >
                We specialize in Electronic Health Records (EHR)
              </h1>
              <p className="text-[#f0f4f9] text-[12px] md:px-8 lg:px-0 md:text-[15px] lg:text-[13px] xl:text-[15px]  sm:text-start  font-normal  sm:leading-[24px] xl:pr-[105px]  md:mt-7">
